...
### 🕳️ D. Réseau de Galeries et Tunnels Continus (*Perlin Worms*)
...
* **Mathématiques / Algorithme** :
  * Agent autonome (Perlin Worm) qui avance pas à pas en modifiant son angle via un bruit 1D et qui creuse un cercle de rayon $R \in [25, 45]\text{px}$.
