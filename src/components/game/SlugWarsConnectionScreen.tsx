...
export const SlugWarsConnectionScreen: React.FC<SlugWarsConnectionScreenProps> = ({
  ...
  useEffect(() => {
    ...
    const drawSlug = (
      ...
      c.beginPath();
      c.ellipse(0, 18, 28, 7, 0, 0, Math.PI * 2);
      c.fill();
      ...
      c.beginPath();
      c.ellipse(0, 10, 15, 6, -0.1, 0, Math.PI * 2);
      c.fill();
    ...
    const drawRockyLedge = (
      ...
      c.fillStyle = '#15803d';
      c.beginPath();
      c.roundRect(-w / 2 - 4, -4, w + 8, 12, 6);
      c.fill();
      c.fillStyle = '#22c55e';
      c.beginPath();
      c.roundRect(-w / 2 - 2, -4, w + 4, 6, 3);
      c.fill();
    ...
    const render = () => {
      ...
      const paraX = Math.max(80, Math.min(width * 0.18, 260));
      ...
      const chopX = Math.max(width - 260, width * 0.82);
      ...
      ctx.lineWidth = 3.5;
      ctx.beginPath();
      ctx.ellipse(0, -26, 44 * Math.cos(rotorAngle), 4, 0, 0, Math.PI * 2);
      ctx.stroke();
      ...
      ctx.lineWidth = 2.4;
      ctx.beginPath();
      ctx.ellipse(-52, -12, 4, 14 * Math.sin(rotorAngle * 2), 0, 0, Math.PI * 2);
      ctx.stroke();
      ...
      const leftLedgeX = Math.max(100, Math.min(width * 0.16, 280));
      ...
      ctx.lineWidth = 2.4;
      ctx.beginPath();
      ctx.ellipse(8, -24, 20, 11, 0.1, Math.PI, 0);
      ctx.fill();
      ctx.stroke();
      // Gold Helmet Star
      ...
      ctx.lineWidth = 2.4;
      ctx.beginPath();
      ctx.ellipse(10, -22, 18, 6, 0.1, 0, Math.PI * 2);
      ctx.fill();
      ctx.stroke();
      ...
      ctx.lineWidth = 2;
      ctx.beginPath();
      ctx.roundRect(-5, -14, 12, 26, 3);
      ctx.roundRect(5, -16, 12, 26, 3);
      ctx.fill();
      ctx.stroke();
      // Yellow TNT Strap
      ctx.fillStyle = '#facc15';
