...
export const GameOverStatsModal: React.FC<GameOverStatsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-2.5 sm:p-4 overflow-y-auto pointer-events-auto select-none animate-in fade-in duration-200">
      <div
        className="bg-zinc-950/95 border border-violet-500/50 rounded-2xl sm:rounded-3xl max-w-xl w-full p-3.5 sm:p-5 flex flex-col max-h-[92vh] shadow-2xl pointer-events-auto space-y-2.5 sm:space-y-3.5"
        style={{
      ...
      >
        ...
        <div className="text-center space-y-0.5 sm:space-y-1">
          <div className="inline-flex items-center justify-center p-2 bg-violet-950/80 border border-violet-500/40 rounded-xl mb-0.5 shadow-inner">
            <Trophy className="w-6 h-6 sm:w-7 sm:h-7 text-amber-400 animate-bounce" />
          </div>
          <h2 className="text-xl sm:text-2xl font-black tracking-wider uppercase text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-500">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-2.5">
          {mvpTeam && (
            <div className="bg-zinc-900/80 border border-amber-500/30 rounded-xl p-2 sm:p-2.5 flex items-center gap-2 sm:gap-2.5">
              <div className="p-1.5 bg-amber-500/20 text-amber-400 rounded-lg shrink-0">
                <Award className="w-4 h-4" />
              </div>
              <div className="min-w-0">
                <div className="text-[9px] uppercase font-bold tracking-wider text-amber-400/90 flex items-center gap-1">
          ...
          {reaperTeam && (
            <div className="bg-zinc-900/80 border border-rose-500/30 rounded-xl p-2 sm:p-2.5 flex items-center gap-2 sm:gap-2.5">
              <div className="p-1.5 bg-rose-500/20 text-rose-400 rounded-lg shrink-0">
                <Skull className="w-4 h-4" />
              </div>
              <div className="min-w-0">
                <div className="text-[9px] uppercase font-bold tracking-wider text-rose-400/90 flex items-center gap-1">
        ...
        <div className="flex-1 overflow-y-auto pr-1 space-y-1.5 sm:space-y-2 min-h-0">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="text-xs sm:text-sm font-black text-zinc-100 truncate flex items-center gap-1.5">
                        ...
                        {isWinner && (
                          <span className="text-[9px] bg-amber-400/20 text-amber-300 border border-amber-400/40 px-1.5 py-0.2 rounded-full uppercase font-bold tracking-wider shrink-0">
                            Vainqueur
                          </span>
                        )}
                      </div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-5 text-right shrink-0">
                    <div>
                      <div className="text-[9px] uppercase text-zinc-400 font-bold">Kills</div>
                      <div className="text-xs sm:text-sm font-black text-rose-400">{kills}</div>
                    </div>
                    <div>
                      <div className="text-[9px] uppercase text-zinc-400 font-bold">Dégâts</div>
        ...
        <div className="pt-2 border-t border-zinc-800/80 flex items-center justify-between gap-3 shrink-0">
          ...
          {isHost && (
            <button
              ...
              className="flex items-center gap-1.5 px-4 sm:px-5 py-2 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 active:scale-95 text-white text-xs sm:text-sm font-black rounded-xl shadow-lg shadow-violet-600/30 transition-all cursor-pointer shrink-0"
            >
