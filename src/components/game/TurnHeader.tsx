            ...
            <div className="bg-zinc-900 border border-amber-500/60 rounded-2xl max-w-sm w-full p-5 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-150 pointer-events-auto">
              ...
              <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-zinc-800">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-amber-600 hover:bg-amber-500 active:bg-amber-700 rounded-lg text-xs font-bold text-white transition shadow active:scale-95 cursor-pointer pointer-events-auto"
                >
                  Confirmer
                </button>
              </div>
