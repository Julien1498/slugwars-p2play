...
export function renderSlugHat(
  ...
  switch (hatId) {
    ...
    case 'bandana': {
      // Red Rambo Bandana with animated ribbons
      ctx.fillStyle = '#dc2626';
      ctx.strokeStyle = '#18181b';
      ctx.lineWidth = 1.4;
    ...
    case 'cyber': {
      // Cyber Vision Goggles with glowing lenses
    ...
    case 'cowboy': {
      // Cowboy Hat in team color with gold badge
    ...
    case 'tophat': {
      // Victorian Top Hat with team color ribbon
      ctx.fillStyle = '#09090b';
    ...
    case 'ninja': {
      // Black Ninja Shinobi headband with animated dark tails
      ctx.fillStyle = '#09090b';
      ctx.strokeStyle = '#27272a';
      ctx.lineWidth = 1.3;
