...
export function renderSkyAndAtmosphere(rc: SkyRenderContext) {
  ...
  // Mountains & Ridges (Anchored to world coordinate grid)
  const mtStep1 = 40;
  ...
  // Midground Ridge (Anchored to world coordinate grid)
  if (isDay) {
  ...
  // Dotted Lush Grass Blade Dashes on Green Hills (Rock-Solid World-Space Grid Alignment)
